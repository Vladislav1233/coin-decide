  ...
  addBar = (event) => {
    ...
    this.props.addBarAdmin("bars", this.state.addBar_id, {
      ...
      geo: new firebase.firestore.GeoPoint(
        +this.state.addBar_latitude,
        +this.state.addBar_longtitude
      ),
    ...
    return (
      <div>
        <section>
          ...
          <a
            href="http://joxi.ru/Q2KYQqWCLRxe9r"
            target="_blank"
          ...
          <form onSubmit={this.addBar}>
            ...
            <div>
              ...
              <input
                name="addBar_id_city"
                value={this.state.addBar_id_city}
                onChange={this.handleInputChange}
              />
            </div>
            ...
            <div>
              ...
              <input
                name="addBar_address"
                value={this.state.addBar_address}
                onChange={this.handleInputChange}
              />
            </div>
            ...
            <div>
              ...
              <input
                name="addBar_end_work_time"
                value={this.state.addBar_end_work_time}
                onChange={this.handleInputChange}
              />
            </div>
            ...
            <div>
              <label>Geo</label>
              <input
                name="addBar_latitude"
                placeholder="Широта"
                value={this.state.addBar_latitude}
                onChange={this.handleInputChange}
              />
              <input
                name="addBar_longtitude"
                placeholder="Долгота"
                value={this.state.addBar_longtitude}
                onChange={this.handleInputChange}
              />
            </div>
...
const mapDispatchToProps = (dispatch) => {
  return {
    addBarAdmin: (collection, doc, data) =>
